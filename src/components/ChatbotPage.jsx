...
export default function ChatbotPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#12080d', color: 'white', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
      ...
      <main style={{ flex: 1, maxWidth: '1280px', margin: '0 auto', width: '100%', padding: '2.5rem', display: 'flex', flexDirection: 'column', position: 'relative', zIndex: 10 }}>
        {/* Header */}
        <header style={{ marginBottom: '2.5rem' }}>
          <h1 className="heading" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)', letterSpacing: '-0.04em', textTransform: 'uppercase', lineHeight: 1, marginBottom: '0.75rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>
              Personalized form analysis and recovery strategies.
            </span>
          </div>
        </header>
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              >
                <Icon icon="lucide:send" style={{ fontSize: '24px', color: '#12080d' }} />
              </button>
            </div>
          </div>
        </div>
