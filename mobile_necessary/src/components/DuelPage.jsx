...
export default function DuelPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#12080d', color: 'white', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
      ...
      <main style={{ flex: 1, padding: 'clamp(1rem, 4vw, 2.5rem)', maxWidth: '1280px', margin: '0 auto', width: '100%', position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }} className="duel-main-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div ref={addCardRef} style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem', alignItems: 'center' }} className="arena-grid">
                {/* Your side */}
                <ArenaSide
                ...
                {/* VS divider */}
                <div style={{ margin: '0 auto', width: '48px', height: '48px', borderRadius: '50%', background: '#12080d', border: '1px solid rgba(212,165,116,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 20px rgba(0,0,0,0.5)', flexShrink: 0 }} className="vs-divider">
                  <span className="heading" style={{ fontSize: '1.25rem', color: '#d4a574' }}>VS</span>
                </div>
      ...
      <style>{`
        ...
        @media (min-width: 1024px) {
          ...
          .arena-grid        { grid-template-columns: 1fr auto 1fr !important; }
          .vs-divider        { width: 64px !important; height: 64px !important; }
        }
      `}</style>
    </div>
  )
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem', opacity: isOpponent ? 0.4 : 1 }}>
      ...
      <div style={{ position: 'relative' }}>
        <div style={{ width: 'clamp(80px, 20vw, 112px)', height: 'clamp(80px, 20vw, 112px)', borderRadius: '50%', border: `4px solid ${isOpponent ? 'rgba(255,255,255,0.1)' : '#d4a574'}`, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', background: isOpponent ? 'rgba(255,255,255,0.05)' : 'rgba(212,165,116,0.1)', boxShadow: isOpponent ? 'none' : '0 0 30px rgba(212,165,116,0.3)' }}>
          {avatarSrc
